...
Successful stages must clear the fail-closed initialization error. A planned or generated result carrying stale error text is invalid for host upload and settlement.
